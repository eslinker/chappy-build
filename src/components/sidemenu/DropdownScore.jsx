  ...
  return (
    <div className="nav-item">
      ...
      <ul id={props.id} className="nav-content list-unstyled collapse" data-bs-parent="#sidebar-nav">
        ...
        <DropdownSubmenuItem title={submenu.menuItem[2].title} path={submenu.menuItem[2].path} />
        <DropdownSubmenuItem title={submenu.menuItem[3].title} path={submenu.menuItem[3].path} />
      </ul>
    </div>
  );
}
